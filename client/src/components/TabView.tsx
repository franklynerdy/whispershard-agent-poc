      ...
      <div className="border-b border-gray-200">
        <nav className="flex flex-wrap -mb-px overflow-x-auto">
          <button
            ...
            className={`py-3 sm:py-4 px-3 sm:px-6 font-medium text-xs sm:text-sm border-b-2 focus:outline-none whitespace-nowrap ${
              activeTab === "chat"
                ? "border-primary text-primary"
                : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
            }`}
          >
            <svg className="h-4 w-4 sm:h-5 sm:w-5 inline-block mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
